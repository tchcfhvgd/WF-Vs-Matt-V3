...
class NoteSplash extends FlxSprite
{
	...
	public function setupNoteSplash(x:Float, y:Float, direction:Int = 0, ?note:Note = null) {
		...
		direction = PlayState.multikeyIndexes[PlayState.keyCount][direction];
		...
		scale.set(PlayState.multikeyScales[PlayState.keyCount]/0.7, PlayState.multikeyScales[PlayState.keyCount]/0.7);
		...
		if(config != null)
		{
			...
			offset.x += offs[0]*scale.x;
			offset.y += offs[1]*scale.y;
